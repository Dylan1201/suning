var oSpans = document.getElementById('tab_hd').querySelectorAll("span[name=choose]");
//console.log(oSpans);
//得到body部分的所有div
var oDivs = document.getElementById('tab_bd').querySelectorAll("div[name=div]");
console.log(oDivs)

var oi = document.getElementById('tab_bd').getElementsByClassName("hx");
//循环批量绑定事件
